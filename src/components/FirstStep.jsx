    ...
    return (
        ...
        className=' pt-[200px] bg-slate-200'>
            <div className="container max-w-[1280px] mx-auto flex flex-wrap px-4">
                <div className='flex w-1/2 pt-12 lg:justify-center lg:w-full'>
                    <motion.img  custom={1} variants={animate.Opacity} className='w-[500px] h-[500px]' src="/firstLogo.svg" alt="" />
                </div>
                <div className=' w-1/2  flex flex-col lg:items-center lg:w-full '>
                    <motion.h1 custom={2} variants={animate.Opacity} className=' text-5xl mb-5'>1. Create beautiful email newsletters</motion.h1>
                    ...
                    <motion.div custom={6} variants={animate.Left} className='flex items-start justify-start mb-5'>
                        <img className=' rounded-2xl mr-6' src="first1.svg" alt="" />
                        <div className='flex flex-col justify-between'>
                            <h2 className=' text-xl text-teal-800 font-extrabold'>Drag-and-drop builder</h2>
                    ...
                    <motion.div custom={6} variants={animate.Left} className='flex mb-5'>
                        <img className=' rounded-2xl mr-6' src="first2.svg" alt="" />
                        <div className='flex flex-col justify-between'>
                            <h2 className=' text-xl font-extrabold'>Pre made templates</h2>
